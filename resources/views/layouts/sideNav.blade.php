        ...
        <aside class="block w-60 bg-gray-400 overflow-auto h-full  max-sm:hidden" >
            
            <div class="grid grid-cols-1">
                @if(Auth::user()->role === 'super_admin')
                    <x-nav-link :href="route('groups.addGroups')" :active="request()->routeIs('groups.addGroups')" class="shadow py-10 px-4">
                    {{ __('Add Group') }}
                    </x-nav-link>
                    <x-nav-link :href="route('groups.addGroupAdmin')" :active="request()->routeIs('groups.addGroupAdmin')" class="shadow py-10 px-4">
                        {{ __('Add Admin') }}
                    </x-nav-link>
              ...
              @endif
                ...
                <x-nav-link :href="route('admin.leaders')" :active="request()->routeIs('admin.leaders')" class="shadow py-10 px-4">
                    {{ __('Add Group Admins') }}
                </x-nav-link>
