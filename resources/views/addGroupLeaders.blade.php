...
<body>
    ...
    <div  class="w-full overflow-auto py-4 px-4 bg-gray-100">
        HOME/add-users
        <form action="{{route('groups.saveGroupLeaders')}}" method="post" class=" py-4 px-4 shadow-xl rounded-xl border-t-4 border-gray-400 w-full mt-4 bg-white">
           @csrf
           @method('post')
         ...
         @endif
           <div class=" grid grid-cols-2 gap-4 max-sm:grid-cols-1">
            <div>
                ...
                <input type="text" name="surname" id="" placeholder="Group name" class=" border border-gray-400 focus:outline-none w-full px-2 py-2 mb-2 mt-2 rounded uppercase">
            </div>
            <div>
                <label for="">Last Name</label> <span class="text-red-400">*</span>
                <input type="text" name="lastname" id="" placeholder="Group name" class=" border border-gray-400 focus:outline-none w-full px-2 py-2 mb-2 mt-2 rounded uppercase">
            </div>
            <div>
                <label for="">Othernames</label>
                <input type="text" name="other_names" id="" placeholder="Group name" class=" border border-gray-400 focus:outline-none w-full px-2 py-2 mb-2 mt-2 rounded uppercase">
            </div>
            <div>
           ...
           <div class=" grid grid-cols-2 gap-4 max-sm:grid-cols-1">
            ...
            <div>
               ...
               <div>
                ...
                <h2 class=" mt-4 mb-4 text-blue-400">User Role</h2>
                 <hr class="mb-2">
                  <div class=" grid grid-cols-2 gap-4 max-sm:grid-cols-1">
                     <div>
                      <label for="">User Role</label> <span class="text-red-400">*</span>
                       <select name="role" class="border border-gray-400 focus:outline-none w-full px-2 py-2 mb-2 mt-2 rounded uppercase" id="">
                        <option value="" selected disabled>--Choose User Role--</option>
                        <option value="secretary">Secretary</option>
                        <option value="loan_officer">Loan Officer</option>
                        <option value="disaster">Disaster & Preparedness Officer</option>
                       </select>
                     </div>
